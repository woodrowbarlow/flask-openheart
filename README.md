...
* [ ] (infra) python debugger workflow?
* [x] (funct) basic route mapping
* [x] (funct) valkey/redis storage backend
* [x] (funct) sqlite storage backend
* [x] (funct) basic plumbing
* [x] (funct) emoji validation
* [ ] (funct) route slugging mechanism
* [ ] (funct) emoji defaults and banlist
* [ ] (funct) emoji sorting
* [ ] (funct) per-route openheart config
